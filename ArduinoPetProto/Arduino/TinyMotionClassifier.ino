...
// This is the model, converted to a C style byte array.
#include "model.h"
...
// Auto resolve all the TensorFlow Lite for MicroInterpreters ops
...
void loop() {
  ...
  */
  ...
  actionDetectedChar.writeValue(0); // set initial value for this characteristic
  ...
  while(1){
    ...
    if (central) {
      ...
      while(central.connected()){
        ...
        while (isCapturing && central.connected()) {
          ...
          if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
            ...
            if (numSamplesRead == NUM_SAMPLES) {
              ...
              actionDetectedChar.writeValue(maxIndex + 1);
        ...
        actionDetectedChar.writeValue(0);
      }
